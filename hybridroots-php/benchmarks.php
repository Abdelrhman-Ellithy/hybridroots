...
$benchmarks = [
    ...
    ['name' => 'f8', 'func' => function($x) { return e$xp($x) - 3.0*$x - 2.0; }, 'a' => 2.0, 'b' => 3.0, 'desc' => 'exp(x) - 3x - 2'],
    ['name' => 'f9', 'func' => function($x) { return pow($x, 2.0) + e$xp($x/2.0) - 5.0; }, 'a' => 1.0, 'b' => 2.0, 'desc' => 'x^2 + exp(x/2) - 5'],
    ...
    ['name' => 'f15', 'func' => function($x) { return e$xp($x) - 3.0*pow($x, 2.0); }, 'a' => 0.0, 'b' => 1.0, 'desc' => 'exp(x) - 3x^2'],
    ...
    ['name' => 'f18', 'func' => function($x) { return pow($x, 2.0) - e$xp($x) - 3.0*$x + 2.0; }, 'a' => 0.0, 'b' => 1.0, 'desc' => 'x^2 - exp(x) - 3x + 2'],
    ['name' => 'f19', 'func' => function($x) { return pow($x - 1.0, 3.0) + 4.0*pow($x - 1.0, 2.0) - 10.0; }, 'a' => 0.0, 'b' => 3.0, 'desc' => '(x-1)^3 + 4(x-1)^2 - 10'],
    ['name' => 'f20', 'func' => function($x) { return e$xp(pow($x, 2.0)) - e$xp(sqrt(2.0)*$x); }, 'a' => 0.5, 'b' => 1.5, 'desc' => 'exp(x^2) - exp(sqrt(2)*x)'],
    ...
    ['name' => 'f29', 'func' => function($x) { return e$xp(-$x) - cos(3.0*$x) - 0.5; }, 'a' => 0.0, 'b' => 1.0, 'desc' => 'exp(-x) - cos(3x) - 0.5'],
    ...
    ['name' => 'f39', 'func' => function($x) { return e$xp(pow($x, 2.0)) - e$xp(1.2*$x); }, 'a' => 0.0, 'b' => 2.0, 'desc' => 'exp(x^2) - exp(1.2x)'],
    ...
    ['name' => 'f46', 'func' => function($x) { return $x*e$xp($x/2.0) - 1.5; }, 'a' => 0.0, 'b' => 1.0, 'desc' => 'x*exp(x/2) - 1.5'],
