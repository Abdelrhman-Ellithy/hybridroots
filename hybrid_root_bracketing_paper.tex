...
\textbf{2. State-of-the-Art Comparison:} The proposed hybrid algorithms significantly outperform modern competitors. The best hybrid, \textbf{Opt.BFMS}, is \textbf{1.7x faster} than the widely-used Brent's method (SciPy, 0.00180s) and \textbf{2.2x faster} than the Quadratic Interval Refinement (QIR) method (0.00243s). This demonstrates that the hybrid approach provides a substantial performance advantage over current state-of-the-art bracketing methods.
