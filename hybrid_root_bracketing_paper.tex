...
\begin{algorithm}[H]
\caption{Pseudocode for the Optimized Bisection-False Position with Modified Secant (Optimized\_BFMS) algorithm. This three-phase hybrid method integrates bisection, false position, and a derivative-free secant step for enhanced convergence.}
\begin{algorithmic}[1]
