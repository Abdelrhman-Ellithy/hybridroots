...
% --- Improved Table IV Caption ---

\begin{table}[H]
\centering
\caption{Detailed iteration counts for each algorithm on all 14 benchmark problems. Each cell shows the number of iterations required to reach convergence for the corresponding problem and algorithm. Data is from Results_tableII.csv. See Table~\ref{tab:algo_legend} for algorithm codes.}
\label{tab:detailed_iterations_14problems}
\resizebox{\textwidth}{!}{
...
HybridBlendTF & 0.00240 & 6.00 \\
HybridBlendBF & 0.00235 & 7.29 \\
Normal False Pos. & 0.00459 & 32.57 \\
Trisection & 0.00523 & 24.93 \\
Normal Bisection & 0.00537 & 46.93 \\
\bottomrule
\end{tabular}
\end{table}
